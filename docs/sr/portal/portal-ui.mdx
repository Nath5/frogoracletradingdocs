...
There are several helpful shortcuts to make navigating the interface even faster. These will toggle different components of the UI while you have the chart open.

:::info
If you need a reminder of the shortcuts there is a link in the sidebar which opens the dialog see in the image below.

![image](_media/ui/keyboard.png ':size=400')
:::

![image](_media/ui/keyboard_shortcuts.png ':size=600')
